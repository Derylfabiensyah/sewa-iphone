<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 grid grid-cols-4 gap-6">
            <div class="bg-white p-6 rounded shadow"><h3 class="text-gray-500">Total iPhones</h3><p class="text-2xl font-bold">{{ $stats['total_iphones'] }}</p></div>
            <div class="bg-white p-6 rounded shadow"><h3 class="text-gray-500">Total Bookings</h3><p class="text-2xl font-bold">{{ $stats['total_bookings'] }}</p></div>
            <div class="bg-white p-6 rounded shadow"><h3 class="text-gray-500">Total Customers</h3><p class="text-2xl font-bold">{{ $stats['total_customers'] }}</p></div>
            <div class="bg-white p-6 rounded shadow"><h3 class="text-gray-500">Pending Payments</h3><p class="text-2xl font-bold">{{ $stats['pending_payments'] }}</p></div>
        </div>
